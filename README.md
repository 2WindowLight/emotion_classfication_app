...
<div>
  ...
  <img src="https://img.shields.io/badge/Firebase-FFCA28?style=flat&logo=Firebase&logoColor=white" alt="Firebase Logo" />
</div>
...
파인튜닝 후 학습한 **BERT 모델**을 기반으로 감정을 분석하고, 결과로 추론된 감정이 우울증과 관련이 있을 경우 이를 시각화하여 사용자가 자신의 상태를 체크하고 피드백을 제공받을 수 있도록 합니다.
